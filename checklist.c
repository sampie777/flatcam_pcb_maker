...
const char *checklist_checks[] = {
        ...
        "Modify GCode files",
        "-- Preparation --",
        "Mount scratcher tool on printer",
        "Saw the board",
        "Set clamp",
        "Clean board",
        ...
        "Turn on scratching tool (optional)",
        ...
        "After print, reset Z-offset to 0.0",
        "Turn off Dremel tool",
        "Secure Z-stop back in place",
        ...
        "-- Solder mask --",
        "Remove board from clamp",
        "Clean the copper side of the bord with wool/alcohol",
        "Cover the board with the temperature resistant paint marker",
        "Make sure to let the marker dry really well",
        "Cover the board with tape",
        "Secure board in clamp (copper side up)",
        "Turn on the printer",
        "Adjust X axis screw for the holes",
        "Turn on Dremel to 14000 RPM",
        "Start 6_cut_solder_mask print",
        "After print: remove cutout tape from the pads",
        "Wipe board with alcohol to remove paint from pads",
        "Turn off printer and Dremel tool",
        "Remove board from clamp",
};
